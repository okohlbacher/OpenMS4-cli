...
START_SECTION((static ToolListType getTOPPToolList()))
{
  ...
  TEST_TRUE(list.contains("DecoyDatabase"))
  TEST_TRUE(list.contains("IndependentTool"))
  TEST_EQUAL(ToolHandler::getToolVersion("IndependentTool"), "7.2.1")
  TEST_EQUAL(ToolHandler::getToolVersion("DOESNOTEXIST"), "")
  TEST_EXCEPTION(Exception::FileNotFound, ToolHandler::findExecutable("IndependentTool"))
